  ...
  return (
    ...
    {/* Founder: Tarun Kumar */}
      <div className="flex pb-3 px-0 w-full flex-col rounded-xl justify-between overflow-hidden transition-shadow bg-white shadow-lg hover:shadow-xl mx-auto md:mr-4">
        <div className="relative">
          ...
          <div className="flex justify-center">
            <Image src='/founders/tarun_kumar.png' className="w-35 h-40" alt='Tarun Kumar' width={100} height={100} />
          </div>
          <div className="flex flex-col items-center" style={{marginTop:-30}}>
            ...
            <p className="text-black" style={{marginTop:-10}}>TECH SAMURAI</p>
      ...
      <div className="relative">
        ...
        <div className="flex flex-col items-center" style={{marginTop:-30}}>
          ...
          <p className="text-black" style={{marginTop:-10}}>AL SHINOBI</p>
          <p className="text-gray-700 text-sm text-justify" style={{marginTop:-5,width:'80%'}}>
            Best thing about GDSC@DSU 2020 is that rather than going for one big event and then staying dormant for the rest of the year, we focused on smaller activities with big impact. These consistent events helped a lot of my peers throughout the year and I am glad to be part of this team through its journey.
          </p>
          <br/>
        </div>
      </div>
    ...
    <div className="relative">
      ...
      <div className="flex flex-col items-center" style={{marginTop:-30}}>
        ...
        <p className="text-black" style={{marginTop:-10}}>VICE PRESIDENT</p>
        <p className="text-gray-700 text-sm text-justify" style={{marginTop:-5,width:'80%'}}>
  ...
  <div className="flex pb-3 px-0 w-full flex-col rounded-xl justify-between overflow-hidden transition-shadow bg-white shadow-lg hover:shadow-xl mx-auto md:mr-4">
    <div className="relative">
      ...
      <div className="flex flex-col items-center" style={{marginTop:-30}}>
        ...
        <p className="text-black" style={{marginTop:-10}}>FLUTTER NINJA</p>
        <p className="text-gray-700 text-sm text-justify" style={{marginTop:-5,width:'80%'}}>
  ...
  <div className="flex pb-3 px-0 w-full flex-col rounded-xl justify-between overflow-hidden transition-shadow bg-white shadow-lg hover:shadow-xl mx-auto md:mr-4">
    <div className="relative">
      ...
      <div className="flex flex-col items-center" style={{marginTop:-30}}>
        ...
        <p className="text-black" style={{marginTop:-10}}>CREATIVE DIRECTOR</p>
        <p className="text-gray-700 text-sm text-justify" style={{marginTop:-5,width:'80%'}}>
  ...
  <div className="flex pb-3 px-0 w-full flex-col rounded-xl justify-between overflow-hidden transition-shadow bg-white shadow-lg hover:shadow-xl mx-auto md:mr-4">
    <div className="relative">
      ...
      <div className="flex flex-col items-center" style={{marginTop:-30}}>
        ...
        <p className="text-black" style={{marginTop:-10}}>FEMME TECH</p>
        <p className="text-gray-700 text-sm text-justify" style={{marginTop:-5,width:'80%'}}>
  ...
  <div className="flex pb-3 px-0 w-full flex-col rounded-xl justify-between overflow-hidden transition-shadow bg-white shadow-lg hover:shadow-xl mx-auto md:mr-4">
    <div className="relative">
      ...
      <div className="flex flex-col items-center" style={{marginTop:-30}}>
        ...
        <p className="text-black" style={{marginTop:-10}}>MARKO TICS</p>
        <p className="text-gray-700 text-sm text-justify" style={{marginTop:-5,width:'80%'}}>
  ...
  <div className="flex pb-3 px-0 w-full flex-col rounded-xl justify-between overflow-hidden transition-shadow bg-white shadow-lg hover:shadow-xl mx-auto md:mr-4">
    <div className="relative">
      ...
      <div className="flex flex-col items-center" style={{marginTop:-30}}>
        ...
        <p className="text-black" style={{marginTop:-10}}>XANTARERS</p>
        <p className="text-gray-700 text-sm text-justify" style={{marginTop:-5,width:'80%'}}>
