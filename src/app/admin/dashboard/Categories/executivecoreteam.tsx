...
export default function ExecutiveCoreTeam() {
        ...
        <div className="max-w-sm mx-auto bg-white rounded-lg shadow-md overflow-hidden">
          <div className="p-4">
            ...
            <div className="text-center">
              <h2 className="text-xl font-bold text-gray-800">Asad Mahmood</h2>
              <p className="text-gray-600 text-sm">Media & Video Production Lead</p>
              <p className="mt-2 text-gray-600 text-sm">
              Asad Mahmood, as our Video Editing and Media Production Lead, played a crucial role in shaping our content strategy and brand presence. His dedication to empowering others within the team and beyond reflected his commitment to excellence and innovation. 
              </p>
            </div>
